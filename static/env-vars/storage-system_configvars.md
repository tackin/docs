...
|`STORAGE_SYSTEM_OC_ROOT`| 1.0.0 |string|Path for the directory where the STORAGE-SYSTEM service stores it's persistent data. If not defined, the root directory derives from $OC_BASE_DATA_PATH/storage.|/home/opencloud/.opencloud/storage/metadata|
